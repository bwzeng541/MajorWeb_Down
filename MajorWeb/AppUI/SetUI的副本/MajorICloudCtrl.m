...
@interface MajorICloudCtrl ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *myTableView;
@property(nonatomic,assign)BOOL isShowAlter;
@end

@implementation MajorICloudCtrl
...
- (void)viewDidLoad {
    ...
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, STATUSBAR_HEIGHT+52, MY_SCREEN_WIDTH, 1)];
    [self.view addSubview:view];
    view.backgroundColor = [UIColor grayColor];
    [btnBack addTarget:self action:@selector(pressBack:) forControlEvents:UIControlEventTouchUpInside];
    self.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, STATUSBAR_HEIGHT+55, MY_SCREEN_WIDTH,MY_SCREEN_HEIGHT-75 ) style:UITableViewStylePlain];
...
-(void)updateAlter{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[MajorICloudSync getInstance] syncNetToLoalInMainThread];
