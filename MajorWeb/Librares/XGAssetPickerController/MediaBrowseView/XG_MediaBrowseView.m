...
@interface XG_MediaBrowseView()<UICollectionViewDelegate,UICollectionViewDataSource,UIGestureRecognizerDelegate,XG_MediaCellDelegate>
...
-(void)syncItemState:(XG_AssetModel*)item{
    [self.syncDelegate syncSelectItem:item];
}
