...
@property (weak, nonatomic) IBOutlet UILabel *alertViewDesLabel;
@property (weak, nonatomic) IBOutlet UIButton *confirmWebBtn;
@property (weak, nonatomic) IBOutlet UIButton *conCancleBtn;
/** 确认按钮 */
