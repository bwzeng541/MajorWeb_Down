...
static Protocol *a3_classProtocol(Class _cls, NSString *suffix, NSString *description)
{
    Class cls = _cls;
    while (cls) {
        NSString *protocolName = suffix;
...
Protocol *a2_delegateUserProtocol(Class cls,NSString *suffix)
{
    return a3_classProtocol(cls, suffix, @"suffix");
}
