...
- (void)didOpen
{
	...
	// Notify delegate
	if ([delegate respondsToSelector:@selector(webMajorSocketDidOpen:)])
	{
		[delegate webMajorSocketDidOpen:self];
	}
}
...
- (void)didReceiveMessage:(NSString *)msg
{
	...
	// Notify delegate
	if ([delegate respondsToSelector:@selector(webMajorSocket:didReceiveMessage:)])
	{
		[delegate webMajorSocket:self didReceiveMessage:msg];
	}
}
