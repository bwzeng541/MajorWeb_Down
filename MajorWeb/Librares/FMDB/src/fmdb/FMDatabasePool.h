...
- (BOOL)dataMajorbasePool:(FMDatabasePool*)pool shouldMajorToPool:(FMDatabase*)database;
...
- (void)dataMajorbasePool:(FMDatabasePool*)pool didMarjorAddDatabase:(FMDatabase*)database;
