...
- (void)addMaskByYBImageBrowserCell:(YBImageBrowserCell *)imageBrowserCell{
    if (_yb_delegate && [_yb_delegate respondsToSelector:@selector(addMaskByYBImageBrowserCell:imageBrowserCell:)]) {
        [_yb_delegate addMaskByYBImageBrowserCell:self imageBrowserCell:imageBrowserCell];
    }
}
