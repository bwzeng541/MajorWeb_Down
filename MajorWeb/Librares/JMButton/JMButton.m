...
-(void)layoutSubviews{
    ...
    self.baseButton.bounds =self.bounds ;
}

-(void)setTitle:(NSString*)title forState:(UIControlState)state{
    [self.baseButton setTitle:title forState:state];
}
...
- (void)addTarget:(id)target action:(SEL)action forControlEvents:(UIControlEvents)controlEvents {
    [self.baseButton removeTarget:nil action:NULL forControlEvents:UIControlEventAllEvents];
