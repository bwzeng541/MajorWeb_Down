...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
    ...
    //add zengbiwang
    SEL didDownProgressSelector;
    
    SEL didUpProgressSelector;
    //end
...
@property (assign) BOOL isAuToRemoveTmp;
...
@property (assign) SEL didDownProgressSelector;
@property (assign) SEL didUpProgressSelector;
@property (retain,readonly) NSString *authenticationRealm;
@property (retain,readonly) NSString *proxyAuthenticationRealm;
@property (retain) NSError *error;
@property (assign,readonly) BOOL complete;
@property (assign)BOOL  isShowProgress;
