var videoJsonText = "";//设置url:["id1","id2"];
...
!function() {
    ...
    function v(e) {
        console.log("VideoHandler %%s", domain);
    ...
    function N(e) {
        ...
        //begin zeng
//        var pos = isSpecialDom();
//        if(t && pos==false){//
//            addmask(e,t);
//        }//end
//        else{//特殊判断
//            if(pos!=-1){
//                var findValue = document.getElementsByName(videoUUIDBTNTag);
//                for(var i=0;i<findValue.length;i++){
//                   var o = findValue[i];
//                    o.parentNode.removeChild(o);
//                }
//                var findmask = findMaskParent();
//                addmask2(e,findmask,videoUUIDBTNTag,t);
//            }
//        }
        //end zeng
        //pos message
...
//        var msg = "sfs";//rc.top+":"+rc.right+":"+rc.left+":"+rc.bottom+":"+rc.width+":"+rc.height;
//        for (var e = window.frames, t = 0; t < e.length; t++)
//        {
//             e[t].postMessage('{"willMaskVideoBtn":' + msg + "}", "*")
//        }//end
//        }
        return t || ""
    }
    ...
    function addmask2(e,q,t,m){
        ...
        btn.style.backgroundColor="transparent";//"#00ff00";
